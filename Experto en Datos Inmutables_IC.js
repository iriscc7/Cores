...
const d3 = ({id}) => id % 3 == 0;
const pd3 = videojuegos.filter(d3)
// console.log(pd3);

//  Un conjunto de videojuegos que pertenecen al género “acción-RPG”.
const e2 = videojuegos.filter(juego => juego.genero.includes("acción-RPG"));
// console.log(e2);

//  Un conjunto de videojuegos que tienen más de un género.
const e3 = videojuegos.filter(juego => juego.genero.includes(" "));
//console.log(e3)

//  Una lista con los nombres de los videojuegos.
const e4 = videojuegos.map(juego=>juego.nombre)
//console.log(e4)
